...
; There's a consistent difference of $12 between X and Y; this consistent distancing is meant to be maintained, so leave it alone!
	...
	Object_PrevYVel:	.ds 1	; $7E unused
...
; NOTE!! This object var is OBJECT SLOT 0 - 4 ONLY!
	...
	SubstTile_Flag:		.ds 1	; $E9 unused [ORANGE] no longer unused; used to flag if we substituted a tile or not
...
MUS1_WORLDVICTORY	= $04	; Victory super (King reverted, Bowser defeated, etc.)
MUS1_BOWSERFALL		= $08	; Bowser dramatic falling
...
RandomN = Random_Pool+1			; Pull a random number from the sequence (NOTE: RandomN+1 is also good; If you need multiple random numbers, call Randomize)
	...
	Objects_Bumped:			.ds 8	; $078E-$0795 unused [ORANGE] No longer unused; tracks when objects are being bumped
