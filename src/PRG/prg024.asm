...
.export Cinematic_ToadAndKing, DiagBox_RowOffs
.export DiagBox_RowOffs_End, Do_Ending2_IntCmd, Do_Title_Screen
.export IntIRQ_TitleEnding
.export Rescue_Princess
