...
MusSeg .macro
   .word \1	; Rest array pointer
   .word \2	; Address of music segment square wave data (sq1 offset in following byte)
   .byte \3	; Square 1 track starting offset
   .word \4	; Triangle track pointer
   .word \5	; Noise track pointer
   .word \6	; DCM track pointer
...
;					   Rest Ptr           Square data    sq1  tri    nse    dpcm
MS2ASegHedr00:	MusSeg Music_RestH_LUT00, M12ASegData00, $13, $0000, $0000, $0000
MS2ASegHedr01:	MusSeg Music_RestH_LUT00, M12ASegData01, $0F, $0000, $0000, $0000
MS2ASegHedr02:	MusSeg Music_RestH_LUT00, M12ASegData02, $0A, $0000, $0000, $0000
MS2ASegHedr03: 	MusSeg Music_RestH_LUT00, M12ASegData03, $0B, $0000, $0000, $0000
MS2ASegHedr04:	MusSeg Music_RestH_LUT00, M12ASegData04, $19, M12ASegData04_Tri, $0000, $0000
MS2ASegHedr05:	MusSeg Music_RestH_LUT30, M12ASegData05, $0A, M12ASegData05_Tri, M12ASegData05_Nse, M12ASegData05_Dpcm
MS2ASegHedr06:	MusSeg Music_RestH_LUT30, M12ASegData06, $2D, M12ASegData06_Tri, M12ASegData06_Nse, M12ASegData06_Dpcm
MS2ASegHedr07:	MusSeg Music_RestH_LUT00, M12ASegData07, $0E, M12ASegData07_Tri, M12ASegData07_Nse, M12ASegData07_Dpcm
MS2ASegHedr08:	MusSeg Music_RestH_LUT30, M12ASegData08, $00, $0000, $0000, M12ASegData08_Dpcm
MS2ASegHedr09:	MusSeg Music_RestH_LUT50, M12ASegData09, $31, M12ASegData09_Tri, M12ASegData09_Nse, M12ASegData09_Dpcm
MS2ASegHedr0A:	MusSeg Music_RestH_LUT30, M12ASegData0A, $37, M12ASegData0A_Tri, M12ASegData0A_Nse, M12ASegData0A_Dpcm
MS2ASegHedr0B:	MusSeg Music_RestH_LUT30, M12ASegData0B, $37, M12ASegData0B_Tri, M12ASegData0B_Nse, M12ASegData0B_Dpcm
MS2ASegHedr0C:	MusSeg Music_RestH_LUT50, M12ASegData0C, $1C, M12ASegData0C_Tri, M12ASegData0C_Nse, M12ASegData0C_Dpcm
MS2ASegHedr0D:	MusSeg Music_RestH_LUT50, M12ASegData0D, $04, M12ASegData0D_Tri, M12ASegData0D_Nse, $0000
MS2ASegHedr0E:	MusSeg Music_RestH_LUT00, M12ASegData0E, $0A, M12ASegData0E_Tri, $0000, M12ASegData0E_Dpcm
MS2ASegHedr0F:	MusSeg Music_RestH_LUT30, M12ASegData0F, $12, M12ASegData0F_Tri, M12ASegData0F_Nse, M12ASegData0F_Dpcm
MS2ASegHedr10:	MusSeg Music_RestH_LUT10, M12ASegData10, $17, M12ASegData10_Tri, M12ASegData10_Nse, M12ASegData10_Dpcm
MS2ASegHedr11:	MusSeg Music_RestH_LUT10, M12ASegData11, $15, M12ASegData11_Tri, M12ASegData11_Nse, M12ASegData11_Dpcm
MS2ASegHedr12:	MusSeg Music_RestH_LUT80, M12ASegData12, $1A, M12ASegData12_Tri, M12ASegData12_Nse, M12ASegData12_Dpcm
MS1_40SegHedr:	MusSeg Music_RestH_LUT80, M12ASegData13, $18, M12ASegData13_Tri, $0000, $0000
MS1_01SegHedr:	MusSeg Music_RestH_LUT30, M12ASegData14, $11, M12ASegData14_Tri, $0000, M12ASegData14_Dpcm
MS1_04SegHedr:	MusSeg Music_RestH_LUT30, M12ASegData15, $11, M12ASegData15_Tri, $0000, M12ASegData15_Dpcm
MS1_20SegHedr:	MusSeg Music_RestH_LUT30, M12ASegData16, $10, M12ASegData16_Tri, M12ASegData16_Nse, M12ASegData16_Dpcm
...
MS1_02SegHedr:	MusSeg Music_RestH_LUT30, M12ASegData18, $12, M12ASegData18_Tri, $0000, $0000
MS1_08SegHedr:	MusSeg Music_RestH_LUT40, M12ASegData19, $27, M12ASegData19_Tri, $0000, M12ASegData19_Dpcm
MS2ASegHedr1A:	MusSeg Music_RestH_LUT30, M12ASegData1A, $14, M12ASegData1A_Tri, $0000, $0000
MS2ASegHedr1B:	MusSeg Music_RestH_LUT00, M12ASegData1B, $1B, $0000, $0000, $0000
MS2ASegHedr1C:	MusSeg Music_RestH_LUT00, M12ASegData1C, $21, $0000, $0000, $0000
MS2ASegHedr1D:	MusSeg Music_RestH_LUT30, M12ASegData1D, $12, M12ASegData1D_Tri, M12ASegData1D_Nse, M12ASegData1D_Dpcm
MS2ASegHedr1E:	MusSeg Music_RestH_LUT30, M12ASegData1E, $23, M12ASegData1E_Tri, M12ASegData1E_Nse, M12ASegData1E_Dpcm
MS2ASegHedr1F:	MusSeg Music_RestH_LUT30, M12ASegData1F, $10, M12ASegData1F_Tri, M12ASegData1F_Nse, M12ASegData1F_Dpcm
MS2ASegHedr20:	MusSeg Music_RestH_LUT30, M12ASegData20, $1D, M12ASegData20_Tri, M12ASegData20_Nse, M12ASegData20_Dpcm
MS2ASegHedr21:	MusSeg Music_RestH_LUT30, M12ASegData21, $24, M12ASegData21_Tri, M12ASegData21_Nse, M12ASegData21_Dpcm
MS2ASegHedr22:	MusSeg Music_RestH_LUT30, M12ASegData22, $0C, M12ASegData22_Tri, M12ASegData22_Nse, M12ASegData22_Dpcm
MS2ASegHedr23:	MusSeg Music_RestH_LUT30, M12ASegData23, $0F, M12ASegData23_Tri, M12ASegData23_Nse, M12ASegData23_Dpcm
MS1_10SegHedr:	MusSeg Music_RestH_LUT30, M12ASegData24, $4C, M12ASegData24_Tri, $0000, M12ASegData24_Dpcm
...
M2BSegHedr00:	MusSeg Music_RestH_LUT30, M2BSegData00, $11, M2BSegData00_Tri, $0000, $0000
M2BSegHedr01:	MusSeg Music_RestH_LUT30, M2BSegData01, $15, M2BSegData01_Tri, M2BSegData01_Nse, M2BSegData01_Dpcm
M2BSegHedr02:	MusSeg Music_RestH_LUT30, M2BSegData02, $12, M2BSegData02_Tri, M2BSegData02_Nse, M2BSegData02_Dpcm
M2BSegHedr03:	MusSeg Music_RestH_LUT30, M2BSegData01, $29, M2BSegData01_Tri, M2BSegData01_Nse, M2BSegData01_Dpcm
M2BSegHedr04:	MusSeg Music_RestH_LUT30, M2BSegData03, $29, M2BSegData03_Tri, M2BSegData03_Nse, M2BSegData03_Dpcm
M2BSegHedr05:	MusSeg Music_RestH_LUT30, M2BSegData04, $15, M2BSegData04_Tri, M2BSegData04_Nse, M2BSegData04_Dpcm
M2BSegHedr06:	MusSeg Music_RestH_LUT30, M2BSegData05, $13, M2BSegData05_Tri, M2BSegData05_Nse, M2BSegData05_Dpcm
M2BSegHedr07:	MusSeg Music_RestH_LUT30, M2BSegData06, $1C, M2BSegData06_Tri, M2BSegData06_Nse, M2BSegData06_Dpcm
M2BSegHedr08:	MusSeg Music_RestH_LUT00, M2BSegData07, $10, M2BSegData07_Tri, $0000, M2BSegData07_Dpcm
M2BSegHedr09:	MusSeg Music_RestH_LUT00, M2BSegData08, $0A, M2BSegData08_Tri, $0000, M2BSegData08_Dpcm
M2BSegHedr0A:	MusSeg Music_RestH_LUT00, M2BSegData09, $0D, M2BSegData09_Tri, $0000, M2BSegData09_Dpcm
M2BSegHedr0B:	MusSeg Music_RestH_LUT00, M2BSegData0A, $29, M2BSegData0A_Tri, M2BSegData0A_Nse, M2BSegData0A_Dpcm
M2BSegHedr0C:	MusSeg Music_RestH_LUT00, M2BSegData0B, $0D, M2BSegData0B_Tri, $0000, $0000
M2BSegHedr0D:	MusSeg Music_RestH_LUT00, M2BSegData0C, $1C, M2BSegData0C_Tri, M2BSegData0C_Nse, M2BSegData0C_Dpcm
M2BSegHedr0E:	MusSeg Music_RestH_LUT00, M2BSegData0D, $1D, M2BSegData0D_Tri, M2BSegData0D_Nse, M2BSegData0D_Dpcm
M2BSegHedr0F:	MusSeg Music_RestH_LUT30, M2BSegData0E, $18, M2BSegData0E_Tri, M2BSegData0E_Nse, M2BSegData0E_Dpcm
M2BSegHedr10:	MusSeg Music_RestH_LUT30, M2BSegData0F, $2C, M2BSegData0F_Tri, M2BSegData0F_Nse, M2BSegData0F_Dpcm
M2BSegHedr11:	MusSeg Music_RestH_LUT30, M2BSegData10, $2B, M2BSegData10_Tri, M2BSegData10_Nse, M2BSegData10_Dpcm
M2BSegHedr12:	MusSeg Music_RestH_LUT30, M2BSegData11, $12, M2BSegData11_Tri, M2BSegData11_Nse, M2BSegData11_Dpcm
M2BSegHedr13:	MusSeg Music_RestH_LUT30, M2BSegData12, $35, M2BSegData12_Tri, M2BSegData12_Nse, M2BSegData12_Dpcm
M2BSegHedr14:	MusSeg Music_RestH_LUT30, M2BSegData13, $30, M2BSegData13_Tri, M2BSegData13_Nse, M2BSegData13_Dpcm
M2BSegHedr15:	MusSeg Music_RestH_LUT00, M2BSegData14, $14, M2BSegData14_Tri, $0000, M2BSegData14_Dpcm
M2BSegHedr16:	MusSeg Music_RestH_LUT00, M2BSegData15, $14, M2BSegData15_Tri, $0000, M2BSegData15_Dpcm
M2BSegHedr17:	MusSeg Music_RestH_LUT30, M2BSegData16, $07, M2BSegData16_Tri, $0000, M2BSegData16_Dpcm
M2BSegHedr18:	MusSeg Music_RestH_LUT30, M2BSegData17, $00, M2BSegData17_Tri, M2BSegData17_Nse, M2BSegData17_Dpcm
M2BSegHedr19:	MusSeg Music_RestH_LUT30, M2BSegData18, $16, M2BSegData18_Tri, M2BSegData18_Nse, M2BSegData18_Dpcm
M2BSegHedr1A:	MusSeg Music_RestH_LUT30, M2BSegData19, $22, M2BSegData19_Tri, M2BSegData19_Nse, M2BSegData19_Dpcm
M2BSegHedr1B:	MusSeg Music_RestH_LUT50, M2BSegData1A, $00, M2BSegData1A_Tri, M2BSegData1A_Nse, M2BSegData1A_Dpcm
M2BSegHedr1C:	MusSeg Music_RestH_LUT40, M2BSegData1B, $19, M2BSegData1B_Tri, M2BSegData1B_Nse, M2BSegData1B_Dpcm
M2BSegHedr1D:	MusSeg Music_RestH_LUT40, M2BSegData1C, $23, M2BSegData1C_Tri, M2BSegData1C_Nse, M2BSegData1C_Dpcm
M2BSegHedr1E:	MusSeg Music_RestH_LUT40, M2BSegData1D, $23, M2BSegData1D_Tri, M2BSegData1D_Nse, M2BSegData1D_Dpcm
M2BSegHedr1F:	MusSeg Music_RestH_LUT70, M2BSegData1E, $0E, M2BSegData1E_Tri, M2BSegData1E_Nse, $0000
M2BSegHedr20:	MusSeg Music_RestH_LUT70, M2BSegData1F, $22, M2BSegData1F_Tri, M2BSegData1F_Nse, M2BSegData1F_Dpcm
M2BSegHedr21:	MusSeg Music_RestH_LUT70, M2BSegData1F, $22, M2BSegData1F_Tri21, M2BSegData1F_Nse21, M2BSegData1F_Dpcm21
M2BSegHedr22:	MusSeg Music_RestH_LUT70, M2BSegData1F, $22, M2BSegData1F_Tri22, M2BSegData1F_Nse22, M2BSegData1F_Dpcm22
M2BSegHedr23:	MusSeg Music_RestH_LUT70, M2BSegData1F, $22, M2BSegData1F_Tri23, M2BSegData1F_Nse23, M2BSegData1F_Dpcm23
M2BSegHedr24:	MusSeg Music_RestH_LUT40, M2BSegData1B, $19, M2BSegData1B_Tri, $0000, $0000
