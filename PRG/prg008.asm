...
PRG008_B42E:
	...
	JSR DoSubstTileAndAttr	 ; Otherwise, substitute tile if effected by P-Switch
...
LATP_Coin:
	;;; [ORANGE] We hook here to use coins to switch the on/off switch
	;;;JSR LATP_CoinCommon	 ; Do common "power up" coin routine
	JSR LATP_CoinCommon_Hook
