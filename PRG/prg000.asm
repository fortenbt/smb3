...
__Level_SlopeQuad40:	; Table now exists in prg030
	; Tile $5F+
...
Object_BoundBox:
	...
	;.byte  5,  14,  10,  18	; 5 (UNUSED) (now used for bowser)
	.byte  4,  18,   10, 30 ; 5
	.byte  2,  27,  -2,  34	; 6
	.byte  2,  20,   2,  12	; 7
	.byte  2,  43,  -2,  18	; 8
...
SpikesEnable:
	.byte TILE1_DOWNSPIKE	;  0 Plains style
	.byte TILE2_SPIKEDOWN	;  1 Mini Fortress style
	.byte TILE3_BOOTSPIKE+1;  2 Hills style (+1 here because boot spikes can only point upward, but
...
Player_Die:
	...
	LDA #$0
	STA Event_Countdown ; Event_Countdown = $30 (ticks until restart level)
